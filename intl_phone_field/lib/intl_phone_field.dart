...
class BuildFlagsButton extends StatelessWidget {
  final EdgeInsets widgetFlagsButtonMargin;
  ...
  const BuildFlagsButton(
      Key key,
      this.widgetFlagsButtonMargin,
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: widgetFlagsButtonMargin,
      child: DecoratedBox(
